...
window.onload = function(){
	var wrap = document.querySelector(".m-idx_banner");
	var box = document.querySelector(".box_c");
	box.innerHTML+=box.innerHTML;
	var aLi = document.querySelectorAll(".box_c li");
	var aNav = document.querySelectorAll("#navc span");
